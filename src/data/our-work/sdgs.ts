...
export const sdgCards: SdgCard[] = [
    ...
    },
    {
        ...
        description: "The SSU Programme's 86% economic activation rate is CNF's most direct contribution to youth employment, entrepreneurship, and inclusive growth.",
    },
];
