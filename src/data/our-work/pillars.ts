/**
 * Detailed Our Work pillar data. Each pillar fills one full-bleed two-column
 * block on `/our-work`. Data only — UI lives in
 * `src/components/sections/our-work/`.
 */

export type PillarTheme = "skills" | "education" | "humanitarian";

/** Accepted icon keys from `@/components/ui/icons.tsx`. Kept as a string
 * union so the JSX layer can map them to actual icon components. */
export type IconKey =
  | "monitor"
  | "scissors"
  | "star"
...
export type PillarBlockData = {
  id: string;
  /** Eyebrow label (e.g. "Pillar One"). */
  pillarLabel: string;
  /** Visual theme — drives accent colour for the column. */
  theme: PillarTheme;
  /** Top-line heading shown in dark ink. */
  heading: string;
  /** Sub-heading shown in the pillar's accent colour. */
  subheading: string;
  /** Lead paragraph rendered larger / bolder. */
  lead: string;
  /** Longer secondary paragraph. */
  body: string;
  /** Four feature rows describing the programmes inside this pillar. */
  features: PillarFeature[];
  /** Programme-specific link (e.g. "Learn More About SSU"). */
  cta: { label: string; href: string };
  /** Photo placeholder text shown until real imagery is supplied. */
  mediaLabel: string;
  /** Headline stat shown directly under the photo. */
  reachStat: { eyebrow: string; value: string; description: string };
  /** Four supporting stats arranged 2×2 below the headline stat. */
  smallStats: PillarSmallStat[];
  /** When true the media column appears on the LEFT (used for Pillar Two). */
  reversed?: boolean;
};
...
export const ourWorkPillars: PillarBlockData[] = [
  {
    ...
    features: [
      {
        ...
        description:
          "AI-assisted coding, prompt engineering, data analysis, web development, digital marketing, graphic design, photography.",
      },
      {
        iconKey: "scissors",
        title: "Vocational Skills Track",
        description:
          "Catering, hair styling, makeup artistry, videography, and more.",
      },
      {
        iconKey: "star",
        title: "Total Man Module (Core — Weekly)",
        description:
          "Character development, financial literacy, leadership, and entrepreneurship.",
      },
      {
        iconKey: "heart",
        title: "Post-Training Support",
        description:
          "Guaranteed internship placement, alumni peer mentorship, and startup capital support.",
      },
    ],
    ...
    reachStat: {
      ...
      value: "86%",
      description:
        "Economic activation rate — graduates employed, interning, or running businesses",
    },
    smallStats: [
  ...
  },
  {
    ...
    lead: "Education is the foundation of everything else. For children in vulnerable communities, financial barriers too often make it an impossible dream — CNF works to change that.",
    ...
    features: [
      {
        ...
        description:
          "Three-year secondary school enrolment for children excluded due to financial constraints.",
      },
      {
        iconKey: "document",
        title: "School Fees & Examination Support",
        description:
          "Direct payment of outstanding fees, WAEC, NECO, and other examination costs.",
      },
      {
        iconKey: "briefcase",
        title: "Academic Resources Distribution",
        description:
          "Textbooks, stationery, and learning materials shared across partner schools.",
      },
      {
        iconKey: "globe",
        title: "Civic Education Workshops",
        description:
          "Building civic awareness, legal literacy, and community engagement among students.",
      },
    ],
    ...
    reachStat: {
      ...
      value: "1,000+",
      description:
        "Students reached through education outreach across partner schools",
    },
    smallStats: [
  ...
  },
  {
    ...
    body: "No circumstance should determine whether a person eats today, receives medical attention, or has their child's hospital bill settled. CNF's Humanitarian Aid and Healthcare pillar delivers direct, tangible support to vulnerable individuals and families — from food relief and festive outreaches to full medical missions and hospital bill offset programmes. Our healthcare focus is particularly centred on those most at risk: pregnant women, young children, and communities with limited access to basic medical services. Through Project HEEM, CNF brings healthcare directly into these communities — because access should never be a privilege.",
    features: [
      {
        iconKey: "food",
        title: "Food Relief & Festive Outreaches",
        description:
          "Prepared food items and relief packages distributed to vulnerable families and communities.",
      },
      {
        iconKey: "stethoscope",
        title: "Project HEEM — Medical Missions",
        description:
          "Free general health check-ups, maternal care, nutritional support for children, and disease prevention in underserved communities.",
      },
      {
        iconKey: "document",
        title: "Hospital Bill Support",
        description:
          "Direct offset of outstanding hospital bills for patients who cannot afford care.",
      },
      {
        iconKey: "baby",
        title: "Maternal & Child Health",
        description:
          "Dedicated support for pregnant women and young children — the most vulnerable members of any community.",
      },
    ],
    cta: {
    ...
    reachStat: {
      ...
      value: "4,000+",
      description:
        "Beneficiaries across food relief, medical care, and emergency support",
    },
    smallStats: [
