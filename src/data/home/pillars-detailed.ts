...
export const homePillars: HomePillar[] = [
    ...
    },
    {
        ...
        badgeTone: "education",
        title: "Access & Equity",
        description: "We re-enrol out of school children, cover exam fees, and provide learning materials, keeping every child on the path to their potential.",
