...
/** Three-pillar cards rendered on the home page (richer than the shared
 * `pillars` constant: includes badge tone, bullet list of programmes, and
 * iconKey for the small top-right icon). */
...
export const homePillars: HomePillar[] = [
  {
    ...
    description:
      "Free, cohort-based training for Nigerian youth — paired with mentorship, internship placement, and alumni support to bridge training and real-world opportunity.",
    programmes: [
  ...
  },
  {
    ...
    description:
      "We re-enrol out-of-school children, cover exam fees, and build civic awareness — laying the groundwork for educated, engaged citizens.",
    programmes: [
  ...
  },
  {
    ...
    description:
      "Food, medical care, and emergency support — delivered directly to vulnerable families and communities when they need it most.",
    programmes: [
