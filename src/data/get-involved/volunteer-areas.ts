...
export const volunteerAreas: VolunteerAreaCard[] = [
  {
    ...
    description:
      "Lead a session — technical, business, or soft-skills — alongside our SSU and mentorship cohorts.",
  },
  {
    id: "mentor",
    ...
    title: "Mentor",
    description:
      "Guide a young person 1-on-1 over a 12-week cycle. We match by industry and time-zone.",
  },
  {
    id: "communications",
    iconKey: "megaphone",
    ...
    description:
      "Help us tell the story — photography, videography, copy, or social media support during outreaches.",
  },
  {
    id: "medical-outreach",
    iconKey: "stethoscope",
    ...
    description:
      "For licensed medical professionals — join Project HEEM missions and free health-camp days.",
  },
  {
    id: "fieldwork-ssu",
    iconKey: "tools",
    ...
    description:
      "Support cohort logistics, learner check-ins, and on-site facilitation for SSU training weekends.",
  },
  {
    id: "administrative",
    iconKey: "clipboard",
    ...
    description:
      "Behind-the-scenes work that keeps programmes running — scheduling, data entry, supply runs, and follow-ups.",
  },
];
