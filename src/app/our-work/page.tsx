...
export const metadata = pageMetadata("Our work", "Three interconnected pillars, Economic Empowerment, Education, and Humanitarian Aid, and how the Chiggy Foundation for Opportunity delivers programmes across Nigeria.");
