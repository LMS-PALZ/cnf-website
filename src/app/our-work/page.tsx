...
export const metadata = pageMetadata("Our work", "Three interconnected pillars, Economic Empowerment, Education, and Humanitarian Aid & Healthcare, and how the Chiggy Foundation for Opportunity delivers programmes across Nigeria.");
