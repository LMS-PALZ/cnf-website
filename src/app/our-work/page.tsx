...
export const metadata = pageMetadata("Our work", "Three interconnected pillars, Skills Development, Education, and Humanitarian Aid & Healthcare, and how the Chiggy Nsofor Foundation delivers programmes across Nigeria.");
