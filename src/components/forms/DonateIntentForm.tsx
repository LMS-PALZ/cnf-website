  ...
  return (
    <form className="space-y-6" noValidate onSubmit={onSubmit}>
      ...
      <FormField
        ...
        hint="Include country code if outside Nigeria."
      >
      ...
      <FormField
        ...
        error={errors.pledgeAmount?.message}
        hint="You can share an indicative amount; finance will confirm details."
      >
        ...
        <Controller
          ...
          render={({ field }) => (
            <input
              id="donate-consent"
              type="checkbox"
              className="mt-1 h-4 w-4 rounded border-cnf-primary/30 text-cnf-primary focus:ring-cnf-primary/30"
              name={field.name}
              checked={field.value}
              onBlur={field.onBlur}
              ref={field.ref}
