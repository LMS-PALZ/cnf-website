...
export function ButtonLink({ href, children, className, variant = "primary", size = "md", external, ariaLabel, }: LinkProps) {
    ...
    return (<Link aria-label={ariaLabel} className={cls} href={href}>
      {children}
    </Link>);
}
