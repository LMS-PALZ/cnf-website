...
/**
 * Small uppercase label used as a category tag inside cards
 * (e.g. "SKILLS DEVELOPMENT" sitting on top of a pillar card).
 */
export function Badge({ children, tone = "neutral", className }: Props) {
  return (
    <span
      className={cn(
        "inline-flex items-center rounded-md px-3 py-1.5 text-[11px] font-semibold uppercase tracking-[0.16em]",
        toneStyles[tone],
        className
      )}
    >
