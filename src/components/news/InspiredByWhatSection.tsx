...
/**
 * Final dark CTA on the news page: "Inspired by What You've Read?"
 * Re-uses `CtaBand` (dark) with two actions \u2014 Donate Today and Get Involved.
 */
export function InspiredByWhatSection() {
  return (
    <CtaBand
      tone="dark"
      id="inspired-by-what-title"
      title={
        <>
          Inspired by What
          <br />
