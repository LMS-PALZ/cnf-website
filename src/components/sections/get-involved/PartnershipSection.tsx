...
/**
 * Combined "Partnership" + "Partner With CNF" section. The left column
 * lists the four partnership shapes; the right column renders the
 * partnership enquiry form. On mobile the columns stack with the form
 * on top so people can act immediately.
 */
    ...
    >
      <Container>
        <SectionHeader
          ...
          titleAccent="With Us."
          accent="primary"
          description="We partner with organisations that share our commitment to evidence-based, dignified, community-centred impact."
        ...
        <div className="mt-12 grid gap-10 lg:grid-cols-2 lg:items-start">
                ...
                <li key={p.id}>
                  <Card tone="outlined" padding="md" className="border-cnf-border">
                    <div className="flex items-start gap-4">
                      <IconTile iconKey={p.iconKey} tone={p.iconTone} size="md" />
                      <div>
                        <h4
                          className={cn(
                            fontDisplay.className,
                            "text-base font-semibold text-cnf-ink"
                          )}
                        >
                          {p.title}
                        </h4>
          ...
          {/* Right column — Partner With CNF form */}
