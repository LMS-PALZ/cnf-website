...
export function GetInvolvedHero() {
    return (<section aria-labelledby="get-involved-hero-title" data-cnf-skip-enter="true" className="relative overflow-hidden bg-cnf-night">
      ...
      <div className="cnf-hero-page-enter-once relative px-6 py-16 sm:px-10 md:px-14 md:py-20 lg:px-16 lg:py-24">
        ...
        <h1 id="get-involved-hero-title" className={`${fontDisplay.className} mt-8 text-5xl font-semibold leading-[1.04] text-white md:text-6xl lg:text-7xl`}>
          Join the
          <br />
        ...
        <ul className="mt-10 flex flex-wrap gap-3">
          {anchorPills.map((pill) => (<li key={pill.href}>
              <Link href={pill.href} className="inline-flex items-center gap-2.5 rounded-full border border-white/10 bg-white/5 px-4 py-2 text-sm font-medium text-white transition-colors hover:border-white/30 hover:bg-white/10 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-cnf-accent">
