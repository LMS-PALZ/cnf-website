...
/**
 * Green band sitting flush below the dark hero. Five stats laid out in a
 * single row on desktop, wrapping on smaller screens.
 */
export function ProjectsStatsBand() {
  return (
    <section
      aria-label="Projects key figures"
      className="bg-cnf-primary-soft py-8 md:py-10"
    >
      <Container>
