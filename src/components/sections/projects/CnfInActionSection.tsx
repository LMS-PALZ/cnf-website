...
/**
 * "Watch Our Work — CNF in Action" video grid. Renders the first
 * `featured: true` video tall (row-span-2 on desktop) and the rest in a
 * flowing 3-column grid alongside it.
 */
export function CnfInActionSection() {
  return (
    <Section tone="dark" padding="lg" ariaLabelledBy="cnf-in-action-title">
      <SectionHeader
