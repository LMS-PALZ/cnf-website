  ...
  return (
    <section className="border-b border-cnf-primary/10 bg-gradient-to-b from-cnf-surface to-white py-16 md:py-24">
      <Container>
        ...
        <h1
          className={`${fontDisplay.className} max-w-3xl text-4xl font-semibold leading-tight text-cnf-ink md:text-5xl`}
        >
          {title}
        </h1>
        {description ? (
          <p className="mt-5 max-w-2xl text-lg leading-relaxed text-cnf-muted md:text-xl">
            {description}
          </p>
        ) : null}
