...
/**
 * "Who we are" — left column has the headline, right column has the
 * narrative copy plus stacked Mission/Vision cards.
 */
        ...
        <div className="lg:col-span-7">
          <div className="space-y-5 text-base leading-relaxed text-cnf-muted md:text-lg">
            <p>
              ...
              Nigerian NGO founded in 2024 with one conviction: that every vulnerable person
          ...
          <div className="mt-8 grid gap-5 sm:grid-cols-2">
            <Card tone="primary" padding="md" className="flex flex-col gap-3">
              ...
              <p
                className={`${fontDisplay.className} text-lg font-medium leading-snug text-white`}
              >
            ...
            <Card tone="outlined" padding="md" className="flex flex-col gap-3 bg-white">
              ...
              <p
                className={`${fontDisplay.className} text-lg font-medium leading-snug text-cnf-ink`}
              >
                To see vulnerable Nigerians given opportunities to have a better quality of
                life.
              </p>
            </Card>
          </div>
