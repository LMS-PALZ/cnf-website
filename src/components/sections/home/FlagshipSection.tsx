...
export function FlagshipSection() {
    return (<Section tone="dark" padding="lg" ariaLabelledBy="flagship-title" id="flagship">
      <div className="grid gap-10 lg:grid-cols-2 lg:gap-16">
        <div>
          <SectionHeader id="flagship-title" eyebrow="Our flagship programme" eyebrowClassName={homeEyebrowClassName} title="The Skill Scale-Up" titleAccent="Programme" tone="dark" accent="accent" description="CFO's flagship, a, cohort-based training programme teaching AI-assisted tools, digital skills, and vocational trades to underserved youth aged 15 to 30. With an 47% economic activation rate, SSU graduates don't just learn. They earn." descriptionClassName="max-w-xl"/>
