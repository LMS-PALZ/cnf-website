...
type Props = {
  /** Pillar list used to render the quick-jump pills below the hero copy. */
...
/**
 * Dark hero band for the Our Work page. Includes a small breadcrumb,
 * the "Three Pillars. One Mission." headline, and three colour-coded
 * pills that scroll to the corresponding `<PillarBlock>` below.
 */
export function OurWorkHero({ pillars }: Props) {
  return (
    ...
    >
      <div
        aria-hidden
        className="cnf-dot-pattern absolute inset-0 opacity-20"
      />
      <div className="relative px-6 py-16 sm:px-10 md:px-14 md:py-20 lg:px-16 lg:py-24">
        ...
        <p className="mt-6 max-w-2xl text-base leading-relaxed text-white/70 md:text-lg">
          ...
          vulnerable Nigerians — equipping people with skills, knowledge, and
