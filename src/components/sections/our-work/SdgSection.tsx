...
/**
 * "Aligned With the UN Sustainable Development Goals" — three SDG cards
 * showing how CNF's pillars map to the global agenda.
 */
export function SdgSection() {
  return (
    <Section tone="surface" padding="lg" ariaLabelledBy="sdg-title">
      <SectionHeader
        id="sdg-title"
      ...
      <div className="mt-10 grid gap-4 md:grid-cols-3 md:gap-6">
        {sdgCards.map((sdg) => (
          <Card
            ...
            tone="elevated"
            padding="md"
            className="flex items-start gap-5 bg-white"
            as="article"
          >
            <div className="flex flex-col">
              ...
              <span
                ...
                className={cn(
                  ...
                  "mt-1 text-5xl font-semibold leading-none md:text-6xl",
                  numberTone[sdg.theme]
                )}
              >
                {sdg.number}
              </span>
