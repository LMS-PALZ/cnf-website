      ...
      <Container>
        <ul className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          {trustPoints.map((point) => {
            ...
            return (<li key={point.id} className="text-center text-white">
                <span aria-hidden className={cn("mx-auto inline-flex h-9 w-9 items-center justify-center [&_svg]:h-6 [&_svg]:w-6", iconToneStyles[point.iconTone])}>
                  <Icon />
                </span>
