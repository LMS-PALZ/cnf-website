    ...
    return (<section aria-label="Beneficiary testimonial" className="bg-cnf-cream py-16 md:py-20">
      <Container>
        <figure className="mx-auto max-w-3xl text-center">
          <span aria-hidden className="mx-auto inline-flex h-10 w-10 items-center justify-center text-cnf-muted/70 [&_svg]:h-7 [&_svg]:w-7">
            <ChatBubbleIcon />
          </span>
          <blockquote className={`${fontDisplay.className} mt-5 text-xl italic leading-relaxed text-cnf-ink md:text-2xl`}>
