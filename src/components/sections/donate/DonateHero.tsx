...
/**
 * Dark, full-bleed donate hero. Mirrors the other page heroes
 * (`OurWorkHero`, `ProjectsHero`, `GetInvolvedHero`) but pairs the
 * headline copy with a translucent stats card on the right that surfaces
 * CNF's reach numbers up front.
 */
        ...
        <div className="mt-8 grid gap-12 lg:grid-cols-[1.1fr,1fr] lg:items-center">
          <div>
            <h1
              ...
              className={`${fontDisplay.className} text-5xl font-semibold leading-[1.04] text-white md:text-6xl lg:text-7xl`}
            >
              Your Gift
              <br />
            ...
            <p className="mt-6 max-w-2xl text-base leading-relaxed text-white/70 md:text-lg">
              ...
              young people, keep children in school, feed vulnerable families,
          ...
          {/* Stats card — translucent dark surface, 2 columns */}
          <aside
            aria-label="Programme reach"
            className="relative rounded-2xl border border-white/10 bg-white/[0.04] p-6 backdrop-blur-sm sm:p-8"
          >
